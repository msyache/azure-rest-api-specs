...
### Tag: package-preview-v1.0-preview

These settings apply only when `--tag=package-preview-v1.0-preview` is specified on the command line.

```yaml $(tag) == 'package-preview-v1.0-preview'
input-file:
  - preview/v1.0-preview/Face.json
```
